...
public class ContactListRowFavVM extends BaseRowVM {
    ...
    public ContactListRowFavVM(People people, ItemContactFavoriteListBinding itemContactFavoriteListBinding){
        mPeople = people;
        mItemContactFavoriteListBinding = itemContactFavoriteListBinding;
